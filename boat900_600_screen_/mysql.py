...
class Mysql:
    ...
    '''用户名，密码，主机地址'''
    def __init__(self,host="tstit.x3322.net", user='ship_6001', password="ship6001@123", db="ship_db", port=3306, charset = "utf8mb4"):
        #获取基础信息
        self.host = host
        self.user = user
        ...
        self.conn = None     # 连接
        self.cursor = None   # 数据库操作游标-游动的游标
        self.sql = ""  # 查询语句
